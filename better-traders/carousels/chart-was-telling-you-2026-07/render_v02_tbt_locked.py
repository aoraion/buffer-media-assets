...
root = Path('/Users/bettybot/clawd/buffer-media-assets/better-traders/carousels/chart-was-telling-you-2026-07')
VERSION = 'v02'
...
def add_gradient(im):
    ...
    for y in range(h):
        for x in range(w):
            ...
            a = min(238, int(198 * left + 52 * top + 102 * bottom))
            pix[x, y] = (0, 4, 10, a)
...
bases = {
    1: Path('/Users/bettybot/.hermes/cache/images/openai_codex_gpt-image-2-medium_20260705_153758_5f5da341.png'),
    2: Path('/Users/bettybot/.hermes/cache/images/openai_codex_gpt-image-2-medium_20260705_153907_66fa06ab.png'),
    3: Path('/Users/bettybot/.hermes/cache/images/openai_codex_gpt-image-2-medium_20260706_132544_3de046d7.png'),
    4: Path('/Users/bettybot/.hermes/cache/images/openai_codex_gpt-image-2-medium_20260706_132656_27f6c49c.png'),
    5: Path('/Users/bettybot/.hermes/cache/images/openai_codex_gpt-image-2-medium_20260706_132828_74f60b42.png'),
    6: Path('/Users/bettybot/.hermes/cache/images/openai_codex_gpt-image-2-medium_20260706_133159_08656c99.png'),
    7: Path('/Users/bettybot/.hermes/cache/images/openai_codex_gpt-image-2-medium_20260706_133312_ff8be8c2.png'),
}

cfg = {
    1: ('THE CHART\nWAS TELLING YOU', 'You swore it came out\nof nowhere. It did not.', 70, 174, 54, 29, 680),
    2: ('That sinking\nfeeling', 'You entered. It reversed.\nYour stomach knew first.', 70, 182, 60, 29, 650),
    3: ('The story\ngot loud', 'Bad luck feels easier\nthan admitting the warning\nwas already there.', 70, 176, 61, 28, 675),
    4: ('Go back\nand look', 'Same candles. Calmer eyes.\nNow the setup is\nimpossible to miss.', 70, 178, 62, 28, 675),
    5: ('Vibes do not\nread charts', 'Feelings move fast.\nStructure waits for you\nto notice.', 70, 178, 60, 28, 650),
    6: ('What TBO\nactually does', 'It does not predict.\nIt organizes the chart\nbefore emotion takes over.', 70, 168, 58, 27, 690),
    7: ('System\nbeats gut', 'Learn to read structure,\nnot chase feelings. That is\nthe process inside\nThe Better Traders.', 70, 178, 63, 27, 700),
}
...
for n, (title, body, x, y, title_size, body_size, maxw) in cfg.items():
    ...
    dest = out / f'tbt-chart-was-telling-you-slide-{n:02d}-{VERSION}-review.png'
...
contact = out / f'tbt-chart-was-telling-you-contact-sheet-{VERSION}-review.png'
...
manifest = {
    'title': 'The Chart Was Telling You',
    'status': 'REVIEW READY',
    'review_only': True,
    'scheduled': False,
    ...
    'copy_gate': 'Claude Opus copy pass completed; Hermes shortened overlay copy, preserved exact The Better Traders brand name, and enforced TBO/no-prediction compliance constraints.',
    ...
    'qa': {
        ...
        'compliance': 'TradingView/TBO education; no real tickers, prices, P&L, broker UI, profit claims, prediction claims, or signal guarantees',
