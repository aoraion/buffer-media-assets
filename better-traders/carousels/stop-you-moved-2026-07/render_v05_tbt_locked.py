...
bases = {
    ...
    6: Path('/Users/bettybot/.hermes/cache/images/openai_codex_gpt-image-2-medium_20260707_164256_c9ddc014.png'),
...
for n, (title, body, x, y, title_size, body_size, maxw) in cfg.items():
    ...
    im = add_gradient(im)
    # Slide 06 v05 uses a newly generated base image with the handwritten rule
    # baked into the journal page. Do not add any synthetic text layer here.
    if n in (1, 7):
        paste_logo(im)
...
manifest = {
    ...
    'copy_gate': 'Claude Worker creative-director feedback incorporated before rerender; v05 applies Aaron note by generating a new slide 06 image with the handwritten rule already baked into the journal page. Slide 04 remains the v03 over-shoulder decision angle.',
    ...
    'qa': {
        ...
        'visuals': 'Dani remains the protagonist; v05 keeps v03 slide 04 and replaces slide 06 with a newly generated journal image where Dani’s handwritten rule is part of the image, not a text overlay: My invalidation is set before I enter.',
