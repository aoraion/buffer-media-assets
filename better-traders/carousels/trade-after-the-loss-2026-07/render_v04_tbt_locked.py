...
bases = {
    ...
    7: Path('/Users/bettybot/.hermes/cache/images/openai_codex_gpt-image-2-medium_20260710_142007_5a9e96cb.png'),
}
...
manifest = {
    ...
    'copy_gate': 'Slide 07 regenerated per Aaron correction using the blue Better Traders Journal cover reference with no candlestick/arrow/chart graphic. Dani’s hand may cover part of the cover title; slides 01-06 are preserved from v01.',
