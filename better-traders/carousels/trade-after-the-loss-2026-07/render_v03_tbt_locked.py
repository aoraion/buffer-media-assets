...
bases = {
    ...
    7: Path('/Users/bettybot/.hermes/cache/images/openai_codex_gpt-image-2-medium_20260710_141449_1a9ad39d.png'),
}
...
manifest = {
    ...
    'copy_gate': 'Slide 07 regenerated per Aaron correction using the blue Better Traders Journal cover reference: white stacked cover title, cursive journal text, green B/candlestick motif. Dani keeps the original calm pose/expression; slides 01-06 are preserved from v01.',
