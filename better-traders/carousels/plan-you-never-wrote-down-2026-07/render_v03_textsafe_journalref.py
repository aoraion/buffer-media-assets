...
OUT=ROOT/'v03-marcus-variety-review-pack'; OUT.mkdir(parents=True,exist_ok=True)
...
7:'/Users/bettybot/.hermes/cache/images/openai_codex_gpt-image-2-medium_20260710_181039_089b5dd9.png'}
COPY={
...
for n in range(1,8):
 ...
 # Each scene reserves a real negative-space column; copy is never allowed over a person, hand, or Journal.
 copy_width={1:430,2:360,3:400,4:440,5:370,6:390,7:365}[n]
 yy=text(d,title,54,154,copy_width,ft(size,'xb'),WHITE,int(size*1.02)); yy+=18
 text(d,body,54,yy,copy_width,ft(24,'reg'),BODY,30); nav(d,n)
 if n==7: d.text((70,1052),'Educational content only. Not financial advice.',font=ft(12,'reg'),fill=(210,220,225,230))
 p=OUT/f'tbt-plan-you-never-wrote-down-slide-{n:02d}-v03-review.png'; im.convert('RGB').save(p,quality=95); exports.append(p)
TW=360; GAP=34; LH=45
